...
if __name__ == '__main__':
    ...
    headers['Host'] = 'doc.bj.baidubce.com'
    ...
    url = 'http://doc.bj.baidubce.com/v2/document/<documentId>?publish'
    response = requests.request("PUT", url, headers=headers,params=query_params)
    print response
    print response.text
