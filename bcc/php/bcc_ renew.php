...
// 第一步：生成认证字符串
$ak = "xxxx";  // AccessKeyId
$sk = "xxxx";  // SecretAccessKey

$method = "PUT";
$host = "bcc.bj.baidubce.com";
$uri = "/v2/instance/i-33F1TcVo";

$params = array("purchaseReserved" => "","clientToken" => uniqid("", true));
...
$url = "http://{$host}{$uri}?purchaseReserved&clientToken={$params["clientToken"]}";
