...
if __name__ == '__main__':
    headers={}
    accesskey='xxxxx'  #您的AK
    secretkey='xxxxx'  #您的SK
    ...
    url = "http://bcc.bj.baidubce.com/v2/securityGroup/<授权的安全组>?authorizeRule&clientToken=%s"%uuid.uuid1()
