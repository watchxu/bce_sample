...
if __name__ == '__main__':
    headers={}
    accesskey='xxxxx'  #用户ak
    secretkey='xxxxx'  #用户sk
    ...
    url = "http://bcc.bj.baidubce.com/v2/instance?clientToken=%s"%uuid.uuid1()
    response = requests.request("POST", url, headers=headers, params=query_params, data=json.dumps(body))
